...
function getCityInfo() {
  ...
  fetch(`https://api.opencagedata.com/geocode/v1/json?q=${encodeURIComponent(cityName)}&key=${apiKey}`)
    ...
    .then((data) => {
      if (data.results.length === 0) {
        ...
        const cityInfo = {
          name: city.components.city || city.components.town || city.components.village || city.components.county,
